              ...
              <div class="mailbox-controls">
                ...
                <div class="pull-right">
                  <ul class="pagination pagination-sm no-margin pull-right">
                    <li><a href="/draft/1">&laquo;</a></li>
                    @for($i=0;$i<$pages;$i++)
                      @if($start == $i)
                      <li><a style="background-color:#ddd !important; cursor:not-allowed" href="/draft/{{$i+1}}">{{$i+1}}</a></li>
                      @else
                      <li><a href="/draft/{{$i+1}}">{{$i+1}}</a></li>
                      @endif
                    @endfor
                    <li><a href="/draft/{{$pages}}">&raquo;</a></li>
                  </ul>
                  <!-- /.btn-group -->
                </div>
                <!-- /.pull-right -->
